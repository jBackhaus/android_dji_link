...
public class msg_param_map_rc extends MAVLinkMessage{
    ...
    */
    ...
    /**
    * Parameter index. Send -1 to use the param ID field as identifier (else the param id will be ignored), sendHeartbeat -2 to disable any existing map for this rc_channel_index.
    */
