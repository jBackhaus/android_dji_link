...
/**
* Request a partial list of mission items from the system/component. http://qgroundcontrol.org/mavlink/waypoint_protocol. If start and end index are the same, just sendHeartbeat one waypoint.
*/
public class msg_mission_request_partial_list extends MAVLinkMessage{
    ...
    */
    ...
    /**
    * End index, -1 by default (-1: sendHeartbeat list to end). Else a valid index of the list
    */
