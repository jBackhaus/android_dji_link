...
public class SERIAL_CONTROL_FLAG {
   ...
   public static final int SERIAL_CONTROL_FLAG_RESPOND = 2; /* Set if the sender wants the receiver to sendHeartbeat a response as another SERIAL_CONTROL message | */
